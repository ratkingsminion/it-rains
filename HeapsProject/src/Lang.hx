...
class Lang {
	...
	public inline static function paused():String {
		return switch(lang) {
			default: 		"PAUSED";
			case German:	"PAUSIERT";
		}
	}

	public inline static function start():String {
		return switch(lang) {
			default: 		"IT RAINS (" + Main.VERSION + ")\n\na sandbox simulation game by ratrogue\n\nfholio.de & ratking.de\n\nmade for the Climate Change: Trial & Error Game Jam 2020\n\nThe tree 3D models are part of the Low Poly Tree Pack by Broken Vector";
			case German:	"IT RAINS (" + Main.VERSION + ")\n\neine Sandbox-Simuation von ratrogue\n\nfholio.de & ratking.de\n\nentstanden für den Climate Change: Trial & Error Game Jam 2020\n\nDie Baum-Modelle sind Teil des Low Poly Tree Pack von Broken Vector";
		}
	}

	public inline static function lose():String {
		return switch(lang) {
			default:		"There are no more trees in your world.\n\nTry again!";
	...
	public inline static function help():String {
		return switch(lang) {
			default: 		"Try to keep your forest alive as long as possible in this sandbox simulation game. From time to time the wind direction (bottom) changes.\n\nTo add a cloud for rain, hover a tile and press LMB. Rotate the camera by keeping RMB pressed, and move it with MMB. The scroll wheel zooms in and out. To (un)pause the game, use the P button in the top right corner.";
			case German:	"In diesem Sandbox-Simulation-Game musst du deinen Wald so lange wie möglich am Leben halten. Ab und zu ändert sich die Windrichtung (s.u.).\n\nFüge eine Regenwolke hinzu, indem du ein Stück Erdboden anklickst. Rotiere die Kamera mit dem rechten Mausbutton, bewege sie mit dem mittleren. Mit dem Scrollrad zoomst du rein und raus. Um das Spiel zu pausieren, drücke den P-Button rechts oben.";
		}
	}
